					...
					<Card className="flex-col ">
						...
						<main className="w-full mt-6">
							<Radio.Group
								...
								buttonStyle="solid"
							>
								<Radio.Button style={RadioStyle} value="a">
									100USDT
								</Radio.Button>
								<Radio.Button style={RadioStyle} value="b">
									200USDT
								</Radio.Button>
							</Radio.Group>
							<Button
				...
				<Col span={24} md={24} className="text-center">
					<Card className="flex-col ">
						...
						<main className="text-left">
							...
							<p>3：单地址只可参与一次预售。</p>
							<p>
								4：温馨提示200u只限联创节点预售，如未完成联创节点要求，只发放100u的预售代币。
							</p>
						</main>
					</Card>
				</Col>
